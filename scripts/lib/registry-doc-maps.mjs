/**
 * Per-domain documentation URL shapes used to backfill registry entries that
 * are missing urlPatterns or bestPracticesPaths.
 *
 * Data tables, not logic — exempt from the 200-line source convention.
 */
